...
var _colorBlindSimulation = __webpack_require__(2);
...
colorNav.addEventListener('click', function (event) {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      (0, _client2['default'])('navClick', 'color');
      setTimeout(function () {
...
contrastNav.addEventListener('click', function (event) {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      (0, _client2['default'])('navClick', 'contrast');
      setTimeout(function () {
...
window.setArtboardNames = function (artboardArray) {
  for (var i = 0; i < artboardArray.length; i++) {
    var opt = document.createElement('option');
    opt.value = 'abid_' + artboardArray[i];
    opt.innerHTML = artboardArray[i];
    artboardSelect.appendChild(opt);
  }
};

window.runSim = function () {
  (0, _colorBlindSimulation.runSimulation)(canvasScale);
};

window.updateCheckerOutput = function (contrastResults) {
...
simulationSelect.addEventListener('change', function (event) {
  ...
  (0, _colorBlindSimulation.runSimulation)();
});
...
starkLogoButton.addEventListener('click', function (event) {
  (0, _client2['default'])('logoButtonClick');
});
...
artboardSelect.addEventListener('change', function (event) {
  console.log(artboardSelect.value);
  (0, _client2['default'])('artboardChange', artboardSelect.value);
...
checkContrastButton.addEventListener('click', function (event) {
  (0, _client2['default'])('checkContrastButtonClick');
});
