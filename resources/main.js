...
import { runSimulation } from './color-blind-simulation'
//
// Select Elements
...
artboardSelect.addEventListener('change', function(event) {
  ...
  pluginCall('artboardChange', artboardSelect.value)
...
checkContrastButton.addEventListener('click', function(event) {
  pluginCall('checkContrastButtonClick')
});
